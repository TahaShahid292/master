...
Route::get('verify/account/{confirmation_code}', 'HomeController@getVerifyAccount')->where('confirmation_code','[A-Za-z0-9]+');
 ...
 Route::group(['middleware' => 'auth'], function() {
	 ...
	 Route::post('buy/subscription/free','SubscriptionsController@buy_free')->name('buy-free');
	...
	Route::post('message/send-bulk', 'MessagesController@send_bulk_message')->name('send-bulk-message');
 ...
 // Creators
	...
	// Profile User
 Route::get('{slug}', 'UserController@profile')->where('slug','[A-Za-z0-9\_-]+')->name('profile-d');
